...
import 'package:hive_mobile/features/calender/widgets/days_widget.dart';
import 'package:hive_mobile/features/calender/widgets/month_widget.dart';
import 'package:hive_mobile/features/calender/widgets/weekdays_widget.dart';
...
class _ScrollableCleanCalendarState extends State<ScrollableCleanCalendar> {
  ...
  late  AppTheme styles;

  @override
  Widget build(BuildContext context) {
    styles = Theme.of(context).extension<AppTheme>()!;
